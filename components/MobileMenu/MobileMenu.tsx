  ...
  return (
    <>
        <AnimatePresence>
            ...
            ?
                <motion.div 
                    className='w-full h-full absolute left-0 top-0 bg-[#252836] z-10 flex flex-col overflow-hidden'
                    key='checkout'
                    initial="from"
                    animate="to"
                    exit="from"
                    variants={fadeInLeft(0.50)}
                >
                    ...
                    <div className='flex-1 flex flex-col justify-between'>
                        <div className='flex flex-col p-10 gap-2 pt-10'>
                            <Link href='/' className='w-full'>
                                <div onClick={handleMenuItemClick} className='w-full h-[60px] px-[20px] flex items-center relative cursor-pointer rounded-lg  hover:bg-slate-700'>
