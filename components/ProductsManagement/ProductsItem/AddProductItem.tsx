...
const AddProductItem = () => {
  ...
  return (
    <div className='w-full h-auto flex justify-center'>
      <div onClick={() => handleAddProductBtnClick()} className='w-full h-[300px] flex flex-col items-center justify-center cursor-pointer rounded-md border-dashed border-[2px] border-[#EA9769]'>
