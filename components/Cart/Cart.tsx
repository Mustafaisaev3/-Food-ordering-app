    ...
    <div className='flex w-screen lg:w-auto'>
        ...
        <div className='flex flex-col justify-between w-full h-screen rounded-tl-lg rounded-bl-lg bg-[#252836] z-20 lg:z-50 lg:w-[450px]'>
            <div className='flex justify-between items-center ps-[28px] border-b border-gray-700' >
                <div className='text-[25px] pl-[28px] text-[white]'>Order: #234556</div>
            ...
            {cartItems.length 
                ...
                <>
                    ...
                    <div className='flex items-center justify-center p-[24px] pt-[10px]'>
                        <div className='flex justify-between items-center p-[24px] cursor-pointer bg-[#EA6969] rounded-lg w-full h-[70px]' onClick={() => setIsCheckout(!isCheckout)}>
                ...
                :
                <div className='h-full p-[28px] flex items-center justify-center flex-col'>
