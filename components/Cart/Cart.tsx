...
function Cart() {
  ...
  return (
    <div className='flex w-screen lg:w-auto'>
        <AnimatePresence>
            {isCheckout && <Checkout closeCheckout={setIsCheckout} />}
        </AnimatePresence>

        <div className='flex flex-col justify-between w-full h-screen rounded-tl-lg rounded-bl-lg bg-[#252836] z-20 lg:z-50 lg:w-[450px]'>
            <div className='flex justify-between items-center ps-[28px] border-b border-gray-700' >
                <div className='text-[25px] pl-[28px] text-[white]'>Cart</div>
                <div className='cursor-pointer p-[28px]' onClick={closeDrawer}>
            ...
            {cartItems.length 
                ? 
                <>
                    <div className='h-full p-[28px] overflow-y-auto'>
                            <div className='w-full h-[50px] text-white flex items-center justify-between '>
                    ...
                    <div className='flex items-center justify-center p-[24px] pt-[10px]'>
                        <button className='flex justify-between items-center p-[24px] cursor-pointer bg-[#EA6969] rounded-lg w-full h-[70px]' onClick={() => setIsCheckout(!isCheckout)}>
                ...
                :
                <div className='h-full w-full p-[28px] flex items-center justify-center flex-col'>
                    <div className='w-full flex flex-col items-center justify-center grow'>
                        ...
                        <div className='text-[40px] text-white'>Your cart is empty</div>
                    </div>

                    <div className='w-full flex items-center justify-center'>
                        <button className='flex justify-between items-center h-[70px] w-full p-[24px] cursor-pointer bg-[#EA6969] rounded-lg opacity-30'>
                            <div className='text-[20px] text-[white]'>Procced to Checkout</div>
                            <span className='ms-auto flex-shrink-0 -mt-0.5 py-0.5 text-[20px] text-white'>
                                <span className='border-s border-[1px] border-white mr-[24px]'></span>
                                {cartTotalPrice}$
